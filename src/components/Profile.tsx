...
import { NOTIFICATIONS_UPDATED_EVENT, type InAppNotification } from '../utils/inAppNotifications';
...
const Profile: React.FC<Props> = ({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto w-full max-w-6xl flex-1 px-4 py-5 md:px-8 md:py-8 xl:px-10 ${isDark ? 'bg-slate-950 text-slate-100' : 'bg-slate-50 text-slate-900'}`}
        role="region"
